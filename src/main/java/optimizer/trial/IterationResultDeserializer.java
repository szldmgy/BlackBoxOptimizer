...
public class IterationResultDeserializer implements JsonDeserializer<IterationResult> {
    //no handler for array based ranges, they are  string based now
    @SuppressWarnings("unchecked")
    @Override
    public IterationResult deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        IterationResult t = gson.fromJson(jsonElement, IterationResult.class);
